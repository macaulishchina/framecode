...
public class FrmKeysConfig {
    ...
    public static final String ISLogin = "SINOYD_KEY_ISLogin";

    public static final String UserToken = "SINOYD_KEY_UserToken";
    //************************* 框架定义键 end*****************************


    //************************* 项目自定义键 start（在此处添加）*****************************
    public static final String Example = "SINOYD_KEY_Example";//项目自定义示例

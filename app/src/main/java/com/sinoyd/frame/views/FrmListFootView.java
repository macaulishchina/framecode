...
public class FrmListFootView extends LinearLayout{
    ...
    public FrmListFootView(Context context) {
        ...
        ivProgress.setLayoutParams(new android.widget.LinearLayout.LayoutParams(DensityUtil.dip2px(context, (float)this.dialogWidth), DensityUtil.dip2px(context, (float)this.dialogWidth)));
        ...
        android.widget.LinearLayout.LayoutParams tvMessageParams = new android.widget.LinearLayout.LayoutParams(-2, -2);

...
public class FrmSegmentedGroup extends RadioGroup {
    ...
    public FrmSegmentedGroup(Context context) {
        super(context);
    ...
    public FrmSegmentedGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        resources = getResources();
        mTintColor = resources.getColor(R.color.radio_button_selected_color);
        mUnCheckedTintColor = resources.getColor(R.color.radio_button_unselected_color);
    ...
    private class LayoutSelector {
        ...
        private int child;
        private final int SELECTED_LAYOUT = R.drawable.frm_radio_checked;
        private final int UNSELECTED_LAYOUT = R.drawable.frm_radio_unchecked;
        ...
        private int getChildren() {
            return FrmSegmentedGroup.this.getChildCount();
        }

        private int getChildIndex(View view) {
            return FrmSegmentedGroup.this.indexOfChild(view);
        }
